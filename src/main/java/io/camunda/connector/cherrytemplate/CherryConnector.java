...
import io.camunda.connector.bpmnmessage.SendBPMNMessageInput;
import io.camunda.connector.bpmnmessage.SendBPMNMessageOutput;
...
public interface CherryConnector {
   ...
   */
  Class<SendBPMNMessageInput> getInputParameterClass();
   ...
   */
  Class<SendBPMNMessageOutput> getOutputParameterClass();
