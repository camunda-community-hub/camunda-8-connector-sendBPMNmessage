...
@Component
public class SendBPMNMessageFunction extends AbstractConnector implements OutboundConnectorFunction {
    ...
    public SendBPMNMessageOutput execute(OutboundConnectorContext context) throws Exception {
        ...
        try {
            ...
            logError("Error during sendMessage [" + messageInput.getMessageName() + "] :" + e);
            throw e;
        }
    ...
    private void sendMessageViaGrpc(String messageName,
        ...
        logInfo("MessageName[" + messageName
                + "] messageId[" + messageId
     ...
     * @param context      job to call to get values
        ...
        while (stVariable.hasMoreTokens()) {
            ...
            if (value != null && value.toString().startsWith("${")) {
                ...
                if (!value.toString().endsWith("}")) {
                    logError("Value [" + value + "] for key [" + name + "] must start by ${ and end by } like ${amount}");
                    continue;
                }
    ...
    public String getName() {
        return "SendBpmnMessage";
    }

    @Override
    public String getDescription() {
        return "Send a BPMN message. Give the message ID, name, correlation and variable to send";
    }
